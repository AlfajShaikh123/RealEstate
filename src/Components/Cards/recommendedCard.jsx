...
function RecommendedCard() {
    ...
    return (
        <>
            <div className="flex justify-center flex-wrap gap-3 mt-7 cursor-pointer text-sm">
                <div className="bg-gray-500 p-3 rounded-xl text-center hover:bg-red-900 w-[100px] ">View All</div>
                <div className="bg-gray-500 p-3 rounded-xl text-center hover:bg-red-900 w-[100px]">Apartment</div>
                <div className="bg-gray-500 p-3 rounded-xl text-center hover:bg-red-900 w-[100px]">Villa</div>
                <div className="bg-gray-500 p-3 rounded-xl text-center hover:bg-red-900 w-[100px]">Studio</div>
                <div className="bg-gray-500 p-3 rounded-xl text-center hover:bg-red-900 w-[100px]">Home</div>
            </div>
